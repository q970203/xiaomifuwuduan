...
module.exports = (req, res, next) => {
  ...
  req.query._sort = req.query._sort ? req.query._sort : require('../../config/global')._sort;
	req.query._type = req.query._type ? req.query._type : require('../../config/global')._type;
  ...
  req.body._type = req.body._type ? req.body._type : require('../../config/global')._type;
  ...
  req.headers._type = req.headers._type ? req.headers._type : require('../../config/global')._type;
